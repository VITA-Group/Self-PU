...
def main():
    ...
    if args.dataset == "mnist":
        ...
        dataset_train1_clean = MNIST_Dataset_FixSample(args.log_path, args.task_name, 1000, 60000, 
            ...
            seed = args.seed)
        # clean dataset初始化为空
        dataset_train1_noisy = MNIST_Dataset_FixSample(args.log_path, args.task_name, 1000, 60000, 
        ...
        dataset_train2_noisy = MNIST_Dataset_FixSample(args.log_path, args.task_name, 1000, 60000, 
            trainX, _trainY, testX, _testY, split='train',
            increasing=args.increasing, replacement=args.replacement, mode=args.self_paced_type, top = args.top2, type="noisy",
            seed = args.seed)
        dataset_train2_clean = MNIST_Dataset_FixSample(args.log_path, args.task_name, 1000, 60000, 
            trainX, _trainY, testX, _testY, split='train', ids=[],
        ...
        dataset_train1_clean = CIFAR_Dataset(args.log_path, args.task_name, 1000, 50000, 
            trainX, _trainY, testX, _testY, split='train', ids=[],
            ...
            seed = args.seed)
        # clean dataset初始化为空
        dataset_train1_noisy = CIFAR_Dataset(args.log_path, args.task_name, 1000, 50000, 
            trainX, _trainY, testX, _testY, split='train',
        ...
        dataset_train2_noisy = CIFAR_Dataset(args.log_path, args.task_name, 1000, 50000, 
            trainX, _trainY, testX, _testY, split='train',
            ...
            seed = args.seed)
        dataset_train2_clean = CIFAR_Dataset(args.log_path, args.task_name, 1000, 50000, 
            trainX, _trainY, testX, _testY, split='train', ids=[],
            increasing=args.increasing, replacement=args.replacement, mode=args.self_paced_type, 
